...
- Detailed set up instructions are in php/MySQL tutorial PDF file on Canvas

- Install XAMPP
- Start Apache and MySQL
- Open MySQL admin panel
- Under User Accounts, change password to root
- In XAMPP installation path/phpMyAdmin/confic.inc, change password to root
- Make a new database, name it project
